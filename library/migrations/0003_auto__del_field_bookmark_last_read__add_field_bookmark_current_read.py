...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Bookmark.last_read'
        db.delete_column('library_bookmark', 'last_read')

        # Adding field 'Bookmark.current_read'
        db.add_column('library_bookmark', 'current_read', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Adding field 'Bookmark.last_read'
        db.add_column('library_bookmark', 'last_read', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Deleting field 'Bookmark.current_read'
        db.delete_column('library_bookmark', 'current_read')
    ...
    models = {
        ...
        'library.bookauthor': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_modified_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 8, 23, 20, 51, 27, 18607)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        'library.bookmark': {
            ...
            'created_time': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'current_read': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_modified_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 8, 23, 20, 51, 27, 18607)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        'library.epubarchive': {
            ...
            'last_modified_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 8, 23, 20, 51, 27, 18607)', 'auto_now': 'True', 'blank': 'True'}),
            'last_nonce': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 8, 23, 20, 51, 27, 23183)'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '2000'}),
